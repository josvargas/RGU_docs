...
La componente de chequeo consiste en un archivo de Verilog que imprime las señales en un archivo y un script en python que luego lee el archivo y calcula el error existente entre los números originalmente en punto fijo que salen del RGU y el valor real del inverso de la raíz cuadrada y calcula un error promedio para cada corrida relacionada a un número de iteraciones específico.
